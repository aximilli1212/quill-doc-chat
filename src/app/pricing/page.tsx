  ...
  const pricingItems = [
    ...
    return (
        <>
            ...
            <MaxWidthWrapper className='mn-8 mt-24 text-center max-w-5xl' >
                                ...
                                return (
                                  <><><div
                                    ...
                                    className={cn(
                                      ...
                                      {
                                        'border-2 border-blue-600 shadow-blue-100': plan === 'Pro',
                                    ...
                                    <div className='p-5'>
                                      <h3 className='my-3 text-center fint-display text-3xl font-bold'>
                                        {plan}
                                      </h3>
                                      <p className='text-gray-500'>
                                        {tagline}
                                      </p>
                                      <p className='my-5 font-display txt-6xl font-semibold'>
                                        ${price}
                                      </p>
                                    ...
                                    <div className='flex h-20 items-center justify-center border-b border-t border-gray-200 bg-gray-50'>
                                      <div className='flex h-20 items-center space-x-1'></div>
                                  ...
                                  </div><ul className='my-10 space-y-5 px-8'>
                                      {features.map(({ text, footnote, negative }) => (
                                        <li key={text} className='flex space-x-5'>
                                          <div className='fleex-shrink-0'>
                                            {negative ? (
